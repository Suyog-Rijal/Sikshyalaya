...
export function StaffCardSkeletonShimmerV4({ className }: { className?: string }) {
    ...
    return (
        <div className={cn("w-full max-w-sm rounded-lg bg-white p-4 shadow", className)} ref={shimmerRef}>
            ...
            <div className="mt-6 space-y-4">
                ...
                <div className="space-y-2">
                    <div className="h-4 w-12 rounded bg-gray-200 shimmer-effect" />
                    <div className="h-4 w-32 rounded bg-gray-200 shimmer-effect" />
                </div>
            </div>
